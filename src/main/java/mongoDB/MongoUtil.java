...
public enum MongoUtil {
	...
	static {
		...
		instance.mongoClient = new MongoClient(new ServerAddress(host, 27017), options);
	}
	...
	public static void main(String[] args) {
		...
		// 查询所有
		Bson filter = Filters.eq("status", 2);
		MongoCursor<Document> documentMongoCursor = MongoUtil.instance.find(coll, filter);
